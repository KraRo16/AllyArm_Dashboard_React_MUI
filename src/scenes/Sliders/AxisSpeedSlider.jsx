...
const AxisSpeedSlider = () => {
  ...
  useEffect(() => {
    if (data["70"] && !sliderChanged) {
      setAxisValue1(data["70"]);
    }
    if (data["71"] && !sliderChanged) {
      setAxisValue2(data["71"]);
    }
    if (data["72"] && !sliderChanged) {
      setAxisValue3(data["72"]);
    }
    if (data["73"] && !sliderChanged) {
      setAxisValue4(data["73"]);
    }
    if (data["74"] && !sliderChanged) {
      setAxisValue5(data["74"]);
    }
  }, [data, sliderChanged]);
