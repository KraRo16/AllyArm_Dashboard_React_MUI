...
const JoySensitivitySlider = () => {
  ...
  useEffect(() => {
    if (data["80"] && !sliderChanged) {
      setAxisValue1(data["80"]);
    }
    if (data["81"] && !sliderChanged) {
      setAxisValue2(data["81"]);
    }
    if (data["82"] && !sliderChanged) {
      setAxisValue3(data["82"]);
    }
    if (data["83"] && !sliderChanged) {
      setAxisValue4(data["83"]);
    }
  }, [data, sliderChanged]);
...
export default JoySensitivitySlider;
